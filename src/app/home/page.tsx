...
export default function Home() {
  ...
  // Redirect unauthenticated users to root (landing page)
  useEffect(() => {
  ...
  if (!isAuthenticated) {
    return null; // Will redirect to root (landing page)
  }
  ...
  return (
    <ProtectedRoute>
      <div className="container mx-auto p-4">
            ...
            >
              <div className="flex items-center space-x-4 mb-4">
                <div className="relative">
                  ...
                  <div
                    className={`absolute bottom-0 right-0 w-5 h-5 ${getStatusColor(user.is_online)} rounded-full border-2 border-white`}
                  ></div>
                </div>
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-500">
                    {getLastActiveText(user.last_active_at, user.is_online)}
                  </p>
                  {user.bio && (
        ...
        {users.length === 0 && !usersLoading && !error && (
